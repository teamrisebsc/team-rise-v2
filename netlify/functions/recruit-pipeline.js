...
// Column indices (0-based) matching scrape.js output order
...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Build recruit list from Recruit Tracker (skip header row 0)
    const recruits = []
